function doUpdate(updateJulian) {
  ...
  console.log("Control: ", dt);

  var chunks = dt.split("-");
  year = parseInt(chunks[0]);
  month = parseInt(chunks[1]) - 1;
  day = parseInt(chunks[2]);
  ...
  if (day <= 0 || day > days[month] || year < 2012) {
    alert(
      "Invalid data: Day incorrect or Not a valid day of month or year incorrect"
    );
    return false;
  }
  var jDate = 0;
