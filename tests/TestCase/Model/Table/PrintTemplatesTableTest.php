...
class PrintTemplatesTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = $this->getTableLocator()->exists('PrintTemplates') ? [] : ['className' => PrintTemplatesTable::class];
        $this->PrintTemplates = $this->getTableLocator()->get('PrintTemplates', $config);
    }
