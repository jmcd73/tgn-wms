...
function sumCartons() {
  ...
  currentTotal = parseInt(palletTotal.text()) - currentTotal;
  console.log(
    "total:",
    palletTotal.text(),
    "needed:",
...
$(function() {
  ...
  $(".date-input.production-date").change(function() {
    ...
    $bestBefore = $(this)
      .closest("div.row")
      .find("input.best-before");
    $bestBefore.val($addedDays);
    $datePicker = $bestBefore.datepicker("update", $addedDays);
    console.log($dateInputVal, $addedDays);
  });
