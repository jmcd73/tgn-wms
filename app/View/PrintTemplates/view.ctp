<div class="printTemplates view container">
    ...
    <dl class="dl-horizontal">
        ...
        <dt><?php echo __('Print Controller'); ?></dt>
        <dd>
        ...
        <dt class="mt2"><?php echo __('Sample Image'); ?></dt>
        <dd class="mt2">
    ...
    [
        ...
        <dt class="mt2"><?php echo __('Text Template'); ?></dt>
        <dd class="mt2">
...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Print Template'), ['action' => 'edit', $printTemplate['PrintTemplate']['id']]); ?>
        </li>
        <li><?php echo $this->Form->postLink(__('Delete Print Template'), ['action' => 'delete', $printTemplate['PrintTemplate']['id']], ['confirm' => __('Are you sure you want to delete # %s?', $printTemplate['PrintTemplate']['id'])]); ?>
        </li>
...
<div class="related container">
    <h3><?php echo __('Related Pallet Label Items'); ?></h3>
    ...
    <table class="table table-bordered table-condensed table-striped table-responsive">
        ...
        <tr>
            ...
            <td class="actions">
                <?php echo $this->Html->link(__('View'), ['controller' => 'items', 'action' => 'view', $item['id']], ['class' => 'btn btn-link btn-sm view']); ?>
                <?php echo $this->Html->link(__('Edit'), ['controller' => 'items', 'action' => 'edit', $item['id']], ['class' => 'btn btn-link btn-sm edit']); ?>
                <?php echo $this->Form->postLink(__('Delete'), ['controller' => 'items', 'action' => 'delete', $item['id']], [
    ...
    <h3><?php echo __('Related Carton Label Items'); ?></h3>
    <?php if (!empty($printTemplate['CartonLabel'])): ?>
    <table class="table table-bordered table-condensed table-striped table-responsive">
        <tr>
            <th><?php echo __('Id'); ?></th>
            <th><?php echo __('Active'); ?></th>
        ...
        <?php foreach ($printTemplate['CartonLabel'] as $item): ?>
        <tr>
            <td><?php echo $item['id']; ?></td>
            <td><?php echo $item['active']; ?></td>
            <td><?php echo $item['code']; ?></td>
