        ...
        <table class="table table-bordered table-condensed table-striped table-responsive">
            <thead>
                <tr>
                    ...
                    <th>
                        <?=$this->Paginator->sort('min_days_life', 'Min Life', ['title' => 'If 0 then the default minimum life needed to ship value is used. Otherwise set to number of days before expiry that you want to allow pallets to ship']);?>
                    </th>
