...
?>
<h3><?= __d('cake_dev', 'Release Notes for CakePHP %s.', Configure::version()); ?></h3>
<p>
	<?= $this->Html->link(__d('cake_dev', 'Read the changelog'), 'http://cakephp.org/changelogs/' . Configure::version()); ?>
</p>
<?php
