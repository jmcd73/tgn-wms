...
<?php foreach($locations as $location): ?>
	<tr class="<?= $location['Pallet']['hasSpace'] ? "success" : 'danger';?>">
		<td><?= $location['Pallet']['Location']; ?></td>
		<td><?= $location['Pallet']['pallet_capacity']; ?></td>
		<td><?= $location['Pallet']['Pallets']; ?></td>
		<td><?= $location['Pallet']['hasSpace'] ?
