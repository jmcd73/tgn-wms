<?php $this->Html->script([
    ...
    $this->request->action
        ...
        <div class="row">
            <div class="col-lg-12">
				<h3 class="col-lg-12">
					<?= __( "Print %s Pallet Labels", Inflector::humanize($product_type)) ;
$this->Html->link(
    $this->Html->tag(
        'i',
        '',
    ...
    [
        ...
        'empty' => '(select)'
                        ...
                        <?=$this->Form->hidden('product_type', ['value' => $product_type, 'class' => 'product_type']);?>
                        <?=$this->Form->input('part_pallet', [
    'type' => 'checkbox',
    'data-queryurl' => $this->Html->url(['controller' => 'items', 'action' => 'product'])]);?>
                        <?=$this->Form->input('qty', ['class' => 'qty', 'type' => 'select', 'div' => ['class' => 'form-group', 'style' => 'display: none;']]);?>
                        <?=$this->Form->input('batch_no',
    [
        'options' => $batch_nos,
        'empty' => '(select)'
	]);?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
								<button
									type="button" class="col-lg-12 col-md-12 col-sm-12 tpad btn btn-lg btn-primary print">
									<?=$this->Html->tag('i','', [ 'class' => 'fas fa-print' ]);?> Print
								</button>
                            </div>
                        </div>
