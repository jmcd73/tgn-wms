...
<div class="actions">
	...
	<ul>
		...
		<li><?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $this->Form->value('ProductType.id')], ['confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('ProductType.id'))]); ?></li>
