...
<div class="actions">
	<h3><?= __('Actions'); ?></h3>
	<ul>
		<li><?= $this->Html->link(__('Edit Area Or Type'), ['action' => 'edit', $productType['ProductType']['id']]); ?> </li>
		<li><?= $this->Form->postLink(__('Delete Area Or Type'), ['action' => 'delete', $productType['ProductType']['id']], ['confirm' => __('Are you sure you want to delete # %s?', $productType['ProductType']['id'])]); ?> </li>
	...
	<?php foreach ($productType['Item'] as $item): ?>
		<tr>
			...
			<td class="actions">
				...
				<?= $this->Form->postLink(__('Delete'), ['controller' => 'items', 'action' => 'delete', $item['id']], ['confirm' => __('Are you sure you want to delete # %s?', $item['id'])]); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
	...
	<?php foreach ($productType['Location'] as $location): ?>
		<tr>
			...
			<td class="actions">
				...
				<?= $this->Form->postLink(__('Delete'), ['controller' => 'locations', 'action' => 'delete', $location['id']], ['confirm' => __('Are you sure you want to delete # %s?', $location['id'])]); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
	...
	<?php foreach ($productType['Shift'] as $shift): ?>
		<tr>
			...
			<td class="actions">
				...
				<?= $this->Form->postLink(__('Delete'), ['controller' => 'shifts', 'action' => 'delete', $shift['id']], ['confirm' => __('Are you sure you want to delete # %s?', $shift['id'])]); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
