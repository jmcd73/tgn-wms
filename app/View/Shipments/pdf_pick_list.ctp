...
class XTCPDF extends TCPDF {
	...
	public function Header() {
        ...
        $this->Image( $image_file, 10, 10, 60, '', 'JPG', '', 'B', false, 300, '', false, false, 0, false, false, false);
        // Set font
...
foreach ($pallets as $pallet):
 if($pallet['Label']['item_id'] == $group['Label']['item_id']):
	$pdf->Write(0,
		str_pad($pallet['Location']['location'], 24, ' ', STR_PAD_LEFT) . '    ' . $pallet['Label']['pl_ref'] . '     ' .$pallet['Label']['qty'],
