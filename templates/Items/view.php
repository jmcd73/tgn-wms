...
<li><?= $this->Form->postLink(__('Delete Item'), ['action' => 'delete', $item->id], ['confirm' => __('Are you sure you want to delete # {0}?', $item->id), 'class' => 'nav-link']) ?></li>
<li><?= $this->Html->link(__('List Items'), ['action' => 'index'], ['class' => 'nav-link']) ?> </li>
<li><?= $this->Html->link(__('New Item'), ['action' => 'add'], ['class' => 'nav-link']) ?> </li>
<li><?= $this->Html->link(__('List Pack Sizes'), ['controller' => 'PackSizes', 'action' => 'index'], ['class' => 'nav-link']) ?></li>
<li><?= $this->Html->link(__('New Pack Size'), ['controller' => 'PackSizes', 'action' => 'add'], ['class' => 'nav-link']) ?></li>
...
<li><?= $this->Html->link(__('List Print Templates'), ['controller' => 'PrintTemplates', 'action' => 'index'], ['class' => 'nav-link']) ?></li>
<li><?= $this->Html->link(__('New Print Template'), ['controller' => 'PrintTemplates', 'action' => 'add'], ['class' => 'nav-link']) ?></li>
    ...
    <div class="table-responsive">
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td><?= $item->has('pack_size') ? $this->Html->link($item->pack_size->id, ['controller' => 'PackSizes', 'action' => 'view', $item->pack_size->id]) : '' ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><?= $item->has('print_template') ? $this->Html->link($item->print_template->name, ['controller' => 'PrintTemplates', 'action' => 'view', $item->print_template->id]) : '' ?></td>
            </tr>
            <tr>
    ...
    <div class="related">
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <?php foreach ($item->labels as $labels): ?>
                <tr>
                    <td><?= h($labels->id) ?></td>
