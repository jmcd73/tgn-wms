...
<?php
echo $this->Form->create($shiftReportForm);
        ...
        <?php if (!empty($reports)) : ?>
            <?php foreach ($reports as $report) : ?>
                ...
                <div class="card mb-3">
                                ...
                                <?php foreach ($report['Cartons'] as $carton) : ?>
                                    ...
                                    <tr>
                                        <td colspan="4" class="text-right">
                                            <div class="small pallet-info"><strong>Full Pallet Qty</strong><span class="secondary-text"><?php echo $palletTotal; ?></span></div>
                                            <div class="small pallet-info"><strong>Qty Previous</strong><span class="secondary-text"><?php echo $qtyPrevious; ?></span></div>
                                            <div class="small pallet-info"><strong>Movement</strong><span class="secondary-text"><?php echo __('<span class="{0}">{1}</span>', $movementClass, $movement); ?></span>
                                            </div>
                    ...
                    <?php else : ?>
                        <div class="card-body">
                            <?php echo $this->element('flash/default', [
                                'message' => 'No part or changed quantity pallets during shift',
