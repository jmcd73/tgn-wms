...
<li><?= $this->Html->link(__('Edit Inventory Status'), ['action' => 'edit', $inventoryStatus->id], ['class' => 'nav-link']) ?></li>
<li><?= $this->Form->postLink(__('Delete Inventory Status'), ['action' => 'delete', $inventoryStatus->id], ['confirm' => __('Are you sure you want to delete # {0}?', $inventoryStatus->id), 'class' => 'nav-link']) ?></li>
...
<div class="inventoryStatuses view large-9 medium-8 columns content">
    ...
    <div class="related">
        ...
        <?php if (!empty($inventoryStatus->labels)): ?>
        <div class="table-responsive">
            <table class="table table-striped">
                <tr>
                ...
                <?php foreach ($inventoryStatus->labels as $labels): ?>
                <tr>
                    <td><?= h($labels->id) ?></td>
