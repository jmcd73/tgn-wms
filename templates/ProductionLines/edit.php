...
<li><?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $productionLine->id], ['confirm' => __('Are you sure you want to delete # {0}?', $productionLine->id), 'class' => 'nav-link']) ?></li>
...
<div class="productionLines form content">
    ...
    <fieldset>
        <legend><?= __('Edit Production Line') ?></legend>
        <?php
