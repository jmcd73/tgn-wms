...
<li><?= $this->Html->link(__('Edit Production Line'), ['action' => 'edit', $productionLine->id], ['class' => 'nav-link']) ?></li>
<li><?= $this->Form->postLink(__('Delete Production Line'), ['action' => 'delete', $productionLine->id], ['confirm' => __('Are you sure you want to delete # {0}?', $productionLine->id), 'class' => 'nav-link']) ?></li>
...
<div class="productionLines view large-9 medium-8 columns content">
    ...
    <div class="related">
        ...
        <?php if (!empty($productionLine->labels)): ?>
        <div class="table-responsive">
            <table class="table table-striped">
                <tr>
                ...
                <?php foreach ($productionLine->labels as $labels): ?>
                <tr>
                    <td><?= h($labels->id) ?></td>
