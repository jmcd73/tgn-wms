                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><?= $printTemplate->has('file_template') ?
                                $this->Html->link($printTemplate->file_template, 
                                ['action' => 'sendFile', $printTemplate->id], [ 'title' => "Click this link to download the Glabels template"]) : ''; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <?= $printTemplate->has('parent_print_template') ? 
                            $this->Html->link(
                                $printTemplate->parent_print_template->name, 
                                [
                                    'controller' => 'PrintTemplates', 
                                    'action' => 'view', 
                                    $printTemplate->parent_print_template->id]) : '' ?>
                        </td>
                    </tr>
                    <tr>
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-lg-6 col-md-6"><?= $printTemplate->hasValue('example_image') ? $this->element('printImage/card', [
                                                                    'name' => $printTemplate->name,
                                                                    'description' => $printTemplate->description,
                                                                    'image' => $templateRoot . $printTemplate->example_image,
                                                                    'filename' => $printTemplate->example_image
                                                                ]) : h($printTemplate->example_image); ?></div>
                            </td>
                        </tr>
                        <tr>
